...
Run **Actions → Build platform VSIX → Run workflow**, or push a release tag such as `v0.5.1`. The workflow:
...
```powershell
code --install-extension .\restricted-local-coder-0.5.1-win32-x64.vsix --force
```
