...
```
restricted-local-coder-0.3.1-win32-x64.vsix
restricted-local-coder-0.3.1-win32-x64.vsix.sha256
```
...
```powershell
code --install-extension .\restricted-local-coder-0.3.1-win32-x64.vsix
```
