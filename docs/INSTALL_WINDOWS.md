...
| Release tag | `runtime-preview-0.1.0` |
| Asset | `restricted-local-coder-0.1.0-win32-x64.vsix` |
| Size | `8200334` bytes |
...
$w.DownloadFile("https://github.com/Arjun10g/restricted-local-coder/releases/download/runtime-preview-0.1.0/restricted-local-coder-0.1.0-win32-x64.vsix", "C:\coder\coder.vsix")
```
...
```
https://github.com/Arjun10g/restricted-local-coder/releases/tag/runtime-preview-0.1.0
```
